...
ggsave(grid_plot, file = "gep_liver/figures/km_grid_all_fct_med_test.pdf", width = 27, height = 10)
...
file_names <- paste0(rep("liver_gsea_indeg_wts_", length(tcga)), names(tcga), ".Rda")
...
exp_legend <- ggplot(gradient_exp, aes(x = 1, y = logFC, fill = logFC)) +
              ...
              theme_void() +
              theme(
                axis.text.y = element_text(size = 10),       # Customize x-axis text size
...
ggsave(exp_legend, file = "diff_exp_legend.png")
ggsave(edge_legend, file = "diff_edge_legend.png")
```
