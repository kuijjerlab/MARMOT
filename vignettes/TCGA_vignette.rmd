...
plots <- Map(function(feat, title, file_name, ...) {
  suppressMessages(plot_feat_wts(feat_wts = feat, fct = factors, file_name = file_name, n_feat = 10,
  plot_type = "dotplot", width = 20, height = 20, limitsize = FALSE))
...
save(fisher_result, contingency_table, common_tfs, file = "outdeg_gep_tcga_fisher_result_top10.Rda")
```
...
file_name <- "figures/liver_outdeg_wts_common_gep.pdf"
...
save(gsea_res, file = "gep_liver/liver_gsea_indeg_wts_all_fct_kegg.Rda")
```

```{r plot_gsea_wts}
load("liver_gsea_indeg_wts_all_fct_react.Rda")
...
file_name <- "figures/liver_indeg_gsea_wts_react.pdf"

plot <- gsea_dotplots(merged_df, gene_set = "reactome",
                      title = "TCGA", file_name = file_name, n_path = 20,
                      thresh = NULL, width = 30, height = 30, limitsize = FALSE)
```
