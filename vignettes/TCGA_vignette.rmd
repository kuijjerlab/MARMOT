...
```{r plot_gsea_wts}
load("liver_gsea_indeg_wts_all_fct.Rda")
...
file_name <- "figures/liver_indeg_gsea_wts_hall_top10.pdf"

plot <- gsea_dotplots(merged_df, gene_set = "hallmark",
                      title = "TCGA", file_name = file_name, n_path = 10,
                      thresh = NULL, width = 25, height = 20, limitsize = FALSE)
```
