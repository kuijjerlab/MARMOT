...
surv_df <- data.frame()
for(i in cancers){
  PCA <- get(load(paste0(wd, "/benchmark-new/", i,"_factorisations_pca.Rda")))
  noPCA <- get(load(paste0(wd, "/benchmark-new/", i,"_factorisations_no_pca.Rda")))
  ...
  for(j in methods){
    ...
    save(cox_all, file=paste0("benchmark-new/",i,"_cox_models_", j,".Rda"))
  }
}
save(surv_df, file=paste0(wd, "/benchmark-new/TCGA_surv_all_bench.Rda"))
