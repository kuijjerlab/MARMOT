...
save(corr_df, file = "view_exclusion_corr_df_indeg.Rda")
save(corr_all, file = "view_exclusion_corr_indeg.Rda")

q <- plot_fct_corr(corr_df)
ggsave(q, file = paste0("figures/view_exclusion_heat_both.pdf"),
       height = 10, width = 10)
ggsave(q, file = paste0("figures/view_exclusion_heat_both.png"),
       height = 10, width = 10)
```
