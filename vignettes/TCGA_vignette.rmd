...
exp_legend <- ggplot(gradient_exp, aes(x = 1, y = logFC, fill = logFC)) +
              geom_tile() +
              scale_fill_gradient2(low = cols[2], mid = "white", high = cols[1], midpoint = 0, guide = "none") +
              scale_y_continuous(expand = c(0, 0)) +  # Ensure x-axis covers the full range of data without extra padding
              theme_void() +
              theme(
